    ...
    public class ProductItemData
    {
        public static List<ProductItem> ProductItems = new List<ProductItem>
        {
            new ProductItem {
                ...
                ImageUrl = "https://shopstageclothing.com/cdn/shop/files/9502F0EE-10E1-4E65-A4FC-A847CC958D64.jpg?v=1723552266&width=360",
                Price = 55.00M,
                UserId = "1",
                InventoryQty = 6,
            },
            ...
            new ProductItem {
                ...
                ImageUrl = "https://shopstageclothing.com/cdn/shop/files/839A5C78-33D2-4D9A-9BD7-DFB753CF992C.jpg?v=1723552215&width=360",
                Price = 20.00M,
                UserId = "2",
                InventoryQty = 6,
            },
            ...
            new ProductItem {
                ...
                ImageUrl = "https://shopstageclothing.com/cdn/shop/files/4dab356a-0af4-46c7-8a0d-ce627dbead25.jpg?v=1724598715&width=360",
                Price = 25.00M,
                UserId = "2",
                InventoryQty = 20,
            },
            ...
            new ProductItem {
                ...
                ImageUrl = "https://shopstageclothing.com/cdn/shop/files/THESOUTHERNEARRINGSET.jpg?v=1724599446&width=360",
                Price = 5.00M,
                UserId = "1",
                InventoryQty = 1,
            },
            ...
            new ProductItem {
                ...
                ImageUrl = "https://shopstageclothing.com/cdn/shop/files/IMG-6779.heic?v=1724598933&width=360",
                Price = 20.00M,
                UserId = "1",
                InventoryQty = 4,
            },
